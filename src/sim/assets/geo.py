...
class geo(Asset):
    ...
    Extracts heat from the ground using electrical power.
    Ground temperature is assumed roughly constant (10 °C),
    yielding a stable COP.
    """
    ...
    def __init__(self, name: str, params: Optional[Dict[str, Any]] = None):
        ...
        self.max_power_kw = self.get_float_param("max_power_kw", 10.0)
        self.cop = self.get_float_param("cop", 4.5)
